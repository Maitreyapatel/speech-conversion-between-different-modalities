...
b = fullfile([strcat('../dataset/features/US_102/Whisper/Z.mat')]);
z = load(char(b));
...
for k=1:n
    Feat = a(m:m+999, 1:40);
    Clean_cent = aa(m:m+999, 1:40);
    
    %fprintf('m = %i',m)
    %fprintf('   temp = %i\n',temp)

    save(['../dataset/features/US_102/batches/mcc/Batch_',num2str(temp),'.mat'],'Feat', 'Clean_cent');    
...
if rem>700
    ...
    Clean_cent = [aa(m:m+rem-1, 1:40); b];
