...
mainfolder = "../dataset/features/US_102/batches/"
...
def do_testing():
    print("Testing")
    save_folder = "../results/mask/"
    test_folder_path="../dataset/features/batches"  # Change the folder path to testing directory. (Later)
